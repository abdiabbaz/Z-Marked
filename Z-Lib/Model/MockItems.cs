...
namespace Z_Marked.Model
{
    public class MockItems
    {
        private static List<Item> _items = new List<Item>()
        {
          ...
          new Item(4, "KiMs Chips",14, "Sprøde kartoffelchips, bagt til perfektion for at give en tilfredsstillende crunch.", "Snacks", "Kalorier: 536 per 100g, Kulhydrater: 53g, Fedt: 34g, Protein: 7g, Salt: 1.5g", "/images/Chips.jpg"),          new Item(5, "KiMs Chips",14, "Sprøde kartoffelchips, bagt til perfektion for at give en tilfredsstillende crunch.", "ØL", "Kalorier: 536 per 100g, Kulhydrater: 53g, Fedt: 34g, Protein: 7g, Salt: 1.5g", "/images/Chips.jpg")
