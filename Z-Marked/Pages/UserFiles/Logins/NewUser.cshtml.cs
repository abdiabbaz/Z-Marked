...
namespace Z_Marked.Pages.UserFiles.Logins
{
    ...
    public class NewUserModel : PageModel
    {
        ...
        [StringLength(30, MinimumLength = 6, ErrorMessage = "Længden af kodeord skal være mindst 7 tegn.")]
        [RegularExpression("([A-ZÆØÅ]{1,}[a-zæøå]{3,}\\d{3,})|([a-zæøå]{1,}[A-ZÆØÅ]{1,}[a-zæøå]{2,}\\d{3,})|([a-zæøå]{2,}[A-ZÆØÅ]{1,}[a-zæøå]{1,}\\d{3,})|([a-zæøå]{3,}[A-ZÆØÅ]{1,}[a-zæøå]{0,}\\d{3,})", ErrorMessage = "3 bogstaver (2 små, et stort) og 3 tal")]
